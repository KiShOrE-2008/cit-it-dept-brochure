...
// Chapter ink: brass. The first page of the record proper: the department's
// own identity and the three figures that frame everything after it. The
// greeting to the room lives on Scene01Welcome.
//
...
export const Scene02Department = ({ isActive, onStartClick }) => {
